...
public interface IMovimientoCajaService {
    ...
    Optional<MovimientoCaja> eliminarPorCompra(Long id);
       ...
       /**
     * Registra un egreso en la caja asociado a una compra
     * @param descripcion Descripción del movimiento
     * @param monto Monto del egreso
     * @param cajaId ID de la caja
     * @param compra Compra asociada al egreso
     */
    void registrarEgresoPorCompra(String descripcion, Long monto, Long cajaId, Compra compra);
    
    /**
     * Elimina movimientos de caja asociados a una compra
     * @param compraId ID de la compra
     */
    void eliminarMovimientosPorCompra(Long compraId);
